...
let upgradeHandled = new WeakSet(); // track sockets already handled
...
server.on("upgrade", (req, socket, head) => {
  ...
  // Prevent duplicate handleUpgrade calls for the same socket
  if (upgradeHandled.has(socket)) return;
  upgradeHandled.add(socket);
